...
| 이름 | 역할 | 담당 업무 |
|------|------|-----------|
| 팀원 A | 팀장 / 백엔드 | 데이터 구조 설계, 데이터 전처리, Streamlit 로직 구현 |
| 팀원 B | 프론트엔드 | UI/UX 디자인, 레이아웃 구성, 차트 스타일링 |
| 팀원 C | 데이터 분석 | 데이터 정규화, 통계 분석, 시각화 설계 |
| 팀원 D | 자료 조사 / 발표 | 범죄 데이터 조사, 발표 자료 구성 |

> 실제 역할에 맞춰 편하게 수정하면 됩니다!

---

필요하면 영어 버전 README, PDF 버전, 이미지 포함 버전도 만들어줄게!
